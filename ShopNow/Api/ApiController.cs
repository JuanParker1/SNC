    ...
    public class ApiController : Controller
    {
        ...
        public JsonResult GetShop(string placeid)
        {
            using (WebClient myData = new WebClient())
            {
                ...
                string getDetails = myData.DownloadString("https://maps.googleapis.com/maps/api/place/details/json?place_id=" + placeid + "&key=" + BaseClass.googleMapApiKey);  //AIzaSyCRsR3Wpkj_Vofy5FSU0otOx-6k-YFiNBk
