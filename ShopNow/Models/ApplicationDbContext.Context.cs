...
namespace ShopNow.Models
{
    ...
    public partial class sncEntities : DbContext
    {
        ...
        public virtual ObjectResult<GetProductList1_Result> GetProductList(Nullable<double> longitude, Nullable<double> latitude, string str, Nullable<int> page, Nullable<int> pagesize)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetProductList1_Result>("GetProductList", longitudeParameter, latitudeParameter, strParameter, pageParameter, pagesizeParameter);
        }
