        ...
        public ActionResult BillWiseReport(AccountsBillWiseReportViewModel model)
        {
            ...
            model.ListItems = db.Orders.Where(i => i.Status == 6 && i.DateEncoded.Month == model.MonthFilter && i.DateEncoded.Year == model.YearFilter)
                ...
                .Select(i => new AccountsBillWiseReportViewModel.ListItem
                {
                    ...
                    DeliveryChargePaidToDeliveryBoy = ((i.o.o.Distance <= 5) ? 20 + ((i.o.o.DeliveryRatePercentage / 100) * 20) : 20 + ((i.o.o.DeliveryRatePercentage / 100) * 20) + (i.o.o.IsPickupDrop == false ? ((i.o.o.Distance - 5) * 6 + ((i.o.o.DeliveryRatePercentage / 100) * 6)) : i.o.o.Distance <= 15 ? i.o.o.DeliveryCharge - 50 : (60 + ((i.o.o.Distance - 15) * 8 + ((i.o.o.DeliveryRatePercentage / 100) * 8))))),
