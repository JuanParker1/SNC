    ...
    public class CartController : Controller
    {
        ...
        public ActionResult AssignDeliveryBoy(CartAssignDeliveryBoyViewModel model)
        {
            ...
            if (cart != null && model.DeliveryBoyId != 0)
            {
                ...
                if (delivery.CustomerId != 0)
                {
                    ...
                    Helpers.PushNotification.SendbydeviceId("You have received new order. Accept Soon", "Snowch", "DeliveryNewOrder", "", fcmToken.ToString(), "tune4.caf");
                }
                //Customer
            ...
            model.List = db.Payments.Where(i => i.Status == 0 && i.PaymentMode == "Cash On Hand" && ((model.StartDate != null && model.EndDate != null) ? DbFunctions.TruncateTime(i.DateEncoded) >= DbFunctions.TruncateTime(model.StartDate) && DbFunctions.TruncateTime(i.DateEncoded) <= DbFunctions.TruncateTime(model.EndDate) : true))
                .Join(db.Orders.Where(i => i.Status == 6 && (model.DeliveryBoyId != 0 ? i.DeliveryBoyId == model.DeliveryBoyId : true)), p => p.OrderNumber, c => c.OrderNumber, (p, c) => new { p, c })
                   .Select(i => new CartReportViewModel.CartReportList
                   {
                       ...
                       Amount = i.c.IsPickupDrop == true ? (i.p.RefundAmount != null && i.p.RefundAmount != 0) ? i.c.TotalPrice - (i.p.RefundAmount ?? 0) : i.c.TotalPrice : (i.p.Amount - (i.p.RefundAmount ?? 0)) < 0 ? 0 : i.p.Amount - (i.p.RefundAmount ?? 0),
            ...
            model.DeliveryBoyPaymentStatusLists = db.Orders
                   ...
                   .Join(db.DeliveryBoys, o => o.DeliveryBoyId, d => d.Id, (o, d) => new { o, d })
                       .Select(i => new CartReportViewModel.DeliveryBoyPaymentStatusList
                       {
                           ...
                           DeliveryCharge= i.d.WorkType == 2 ? i.o.DeliveryCharge : i.o.IsPickupDrop == false ? i.o.Distance <= 5 ? (i.o.DeliveryChargeUpto5Km - 15) + ((i.o.DeliveryRatePercentage / 100) * (i.o.DeliveryChargeUpto5Km - 15)) : (i.o.DeliveryChargeUpto5Km - 15) + ((i.o.DeliveryRatePercentage / 100) * (i.o.DeliveryChargeUpto5Km - 15)) + ((i.o.Distance - 5) * i.o.DeliveryChargePerKm + ((i.o.DeliveryRatePercentage / 100) * i.o.DeliveryChargePerKm)) : i.o.Distance <= 5 ? (i.o.DeliveryChargeUpto5Km - 30) + ((i.o.DeliveryRatePercentage / 100) * (i.o.DeliveryChargeUpto5Km - 30)) : i.o.Distance < 15 ? (i.o.DeliveryChargeUpto5Km - 30) + ((i.o.DeliveryRatePercentage / 100) * (i.o.DeliveryChargeUpto5Km - 30)) + ((i.o.Distance - 5) * 6 /*+ ((i.c.c.DeliveryRatePercentage / 100) * 6)*/) : (i.o.DeliveryChargeUpto5Km - 30) + ((i.o.DeliveryRatePercentage / 100) * (i.o.DeliveryChargeUpto5Km - 30)) + (60 + ((i.o.Distance - 15) * 8)),
        ...
        public ActionResult BatchList(BatchOrderListViewModel model)
        {
            ...
            model.ListItems = db.Orders.Where(i => i.Status == 2 && (model.ShopId != 0 ? i.ShopId == model.ShopId : true) /*&& SqlFunctions.DateDiff("minute", i.DateEncoded, DateTime.Now) <= 10*/)
                   ...
                   }).Where(i => (double)(GetMeters(i.CustomerLatitude, i.CustomerLongitude, i.ShopLatitude, i.ShopLongitude) / 1000) <= 4).ToList();
            return View(model);
        }
        ...
        [AccessPolicy(PageCode = "SNCCPDR315")]
        ...
        [AccessPolicy(PageCode = "SNCCDLM316")]
