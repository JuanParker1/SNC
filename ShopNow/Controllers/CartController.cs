            ...
            model.DeliveryBoyPaymentStatusLists = db.Orders
                   ...
                   .Join(db.DeliveryBoys, o => o.DeliveryBoyId, d => d.Id, (o, d) => new { o, d })
                       .Select(i => new CartReportViewModel.DeliveryBoyPaymentStatusList
                       {
                           ...
                           DeliveryCharge= i.d.WorkType == 2 ? i.o.DeliveryCharge : i.o.IsPickupDrop == false ? i.o.Distance <= 5 ? (i.o.DeliveryChargeUpto5Km - 15) + ((i.o.DeliveryRatePercentage / 100) * (i.o.DeliveryChargeUpto5Km - 15)) : (i.o.DeliveryChargeUpto5Km - 15) + ((i.o.DeliveryRatePercentage / 100) * (i.o.DeliveryChargeUpto5Km - 15)) + ((i.o.Distance - 5) * i.o.DeliveryChargePerKm + ((i.o.DeliveryRatePercentage / 100) * 6)) : i.o.Distance <= 5 ? (i.o.DeliveryChargeUpto5Km - 30) + ((i.o.DeliveryRatePercentage / 100) * (i.o.DeliveryChargeUpto5Km - 30)) : i.o.Distance < 15 ? (i.o.DeliveryChargeUpto5Km - 30) + ((i.o.DeliveryRatePercentage / 100) * (i.o.DeliveryChargeUpto5Km - 30)) + ((i.o.Distance - 5) * 6 /*+ ((i.c.c.DeliveryRatePercentage / 100) * 6)*/) : (i.o.DeliveryChargeUpto5Km - 30) + ((i.o.DeliveryRatePercentage / 100) * (i.o.DeliveryChargeUpto5Km - 30)) + (60 + ((i.o.Distance - 15) * 8)),
